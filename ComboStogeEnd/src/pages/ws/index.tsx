      ...
      if (info.file.status === 'done') {
        ...
        uploadImg(formData).then((res) => {
          ...
          if (res.type.indexOf('image') !== -1) {
            ...
            valueType = ` <a href=${res.url} download=${
              res.fileName
            }> <div class='ws-dow'>
                            <div class='dow-left'> <h5>${
                              res.fileName
                            }</h5>  <label>${size}</label></div>
        ...
        <div className="box" id="box">
          <div className="scroll">
            {data.map((it: any, ix: React.Key | null | undefined) => (
              <div
                className={it.name == name ? 'item right' : 'item left'}
                key={ix}
              >
                <img
                  className="header-img"
                  src="https://images-1300238189.cos.ap-shanghai.myqcloud.com/icon/saqure.png"
                />
                <div className=".p">
